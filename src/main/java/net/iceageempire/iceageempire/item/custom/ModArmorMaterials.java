...
public enum ModArmorMaterials implements ArmorMaterial {
    RUBY("ruby", 24, new int[]{ 2, 5, 6, 2 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 0f, 0f, () -> Ingredient.of(ModItems.RUBY.get()));
//    RUBY2("ruby", 24, new int[]{ 2, 5, 6, 2 }, 25,
//    SoundEvents.ARMOR_EQUIP_GOLD, 0f, 0f, () -> Ingredient.of(ModItems.RUBY.get()));
    ...
    public String getName() {
        return MyFirstMod.MODID + ":" + this.name;
    }
